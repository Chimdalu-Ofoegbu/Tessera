...
**Core Value:** A judge or collector can open Tessera, understand the collectible market at a glance, and **trust the numbers because every source, timestamp, and confidence band is visible** — then drill into one category — all without explanation. If everything else fails, this transparent, readable market view must work.
