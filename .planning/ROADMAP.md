...
- [x] **Phase 3: API & Cache** - Cached JSON API that wires source to engines and serves provenance on every metric with an SPA-safe deploy config ✓ 2026-07-06 (public deploy in Phase 6)
- [x] **Phase 4: Frontend Views & Charts** - Overview and category-detail views with the index chart and risk breakdown — the end-to-end walkthrough
- [x] **Phase 5: Trust & Safety UI + Polish** - Shared provenance/confidence/insufficient-data affordances, honest copy, and accessibility applied everywhere
...
| 3. API & Cache | 2/2 | ✓ Done | 2026-07-06 |
| 4. Frontend Views & Charts | ✓ | ✓ Done | 2026-07-08 |
| 5. Trust & Safety UI + Polish | ✓ | ✓ Done | 2026-07-08 |
