...
**Live:** https://tessera-terminal.vercel.app · API base: `https://tessera-terminal.vercel.app/api`. All responses are JSON; **every metric is wrapped in a provenance envelope** and can be `insufficient`:
